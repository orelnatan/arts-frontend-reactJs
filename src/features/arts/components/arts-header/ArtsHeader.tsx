...
import { Direction, Theme, useDirectionContext, useThemeContext } from '@arts/core';
...
export default function ArtsHeader({ keyPrefix, title, withRedirectArrow, search, redirect }: ArtsHeaderProps) {
  ...
  return (
    <div className={`arts-header-main ${THEME_TO_BACKGROUND[theme]}`}>
      <section>
        {withRedirectArrow && <span className='redirect-arrow font-size-20'>
          <SvgIcon 
            icon={sideArrow}
            style={{
